...
export default class Tieu extends Component {
    ...
    componentDidMount() {
        ...
        reportService.GetServiceSource(3)
            .then((response) => {
    ...
    _onPress = () => {
        ...
        // Loai bao cao
        // Bao cao theo ngay
            reportService.BR_ReportTotalOutput_FlashChart(dataPhantichValue, dataSourceValue, dataServiceValue, this.ConvertStringToInt(fromDate), this.ConvertStringToInt(endDate))
                .then((response) => {
            ...
            if (this.state.dataTonghopValue == "1") {
                reportService.BR_ReportTotalOutput_GetRows(dataPhantichValue,dataSourceValue, dataServiceValue, this.ConvertStringToInt(fromDate), this.ConvertStringToInt(endDate))
                    .then((response) => {
                ...
                reportService.BR_ReportTotalOutput_Detail_GetRows(dataPhantichValue,dataSourceValue, dataServiceValue, this.ConvertStringToInt(fromDate), this.ConvertStringToInt(endDate))
                    .then((response) => {
                      console.log(response.ListData)
                        this.setState({
